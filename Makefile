...
stud: stud.c bufferpool.c bufferpool.h
	gcc -O0 -g -std=c99 -fno-strict-aliasing -Wall -W -I/usr/include/libev -I/usr/local/include -L/usr/local/lib -I. -o stud bufferpool.c stud.c -D_GNU_SOURCE -lssl -lcrypto -lev
